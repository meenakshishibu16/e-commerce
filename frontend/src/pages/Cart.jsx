    ...
    <div>
      ...
      <div className="cartWrap">
        ...
        <div className="summary">
          ...
          <div className="hr" />
          <button className="btn" disabled={items.length===0 || loading || !user} title={!user?"Login required for checkout":""} onClick={()=>nav("/checkout")}>
            Proceed to checkout
          </button>
          {!user && <div className="small" style={{marginTop:8}}>Login to checkout.</div>}
        </div>
      </div>
    </div>
  );
